  ...
  const contentTemplates = {
    ...
    'photobooth-canada-sponsors-tedxuoft-2025': {
      content: `
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Why TEDxUofT Matters</h2>
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Our Contribution to the Event</h2>
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Innovation Meets Inspiration</h2>
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Supporting the Next Generation</h2>
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Community Engagement</h2>
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Looking Forward</h2>
        ...
        <h2 class="text-3xl font-light text-gray-900 mt-8 mb-4">Get Involved</h2>
